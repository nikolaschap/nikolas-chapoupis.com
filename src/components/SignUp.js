      ...
      >
        <div data-style="full">
          ...
          >
            ...
            >
              <p>
                Abonniere, um über neue Artikel per Email benachrichtigt zu werden.
              </p>
            </div>
          ...
          <div data-element="column" className="formkit-column">
            ...
            {this.state.success ? (
              <div className="formkit-alert formkit-alert-success">
                ...
                <p>
                  Danke fürs Abonnieren. Suche in deiner Inbox nach einer E-Mail mit einem Bestätigungslink.
                </p>
              </div>
            ) : (
              <>
                ...
                >
                  <p>I werde dich nicht spammen.</p>
                  <p>
                    De-abonniere <em>jederzeit</em>.
                  </p>
                </div>
              </>
            )}
